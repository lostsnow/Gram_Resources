...
class FileManager:
    @staticmethod
    async def save_file(file_path: str, file_content: bytes):
        """保存文件"""
    ...
    @staticmethod
    def get_raw_file_path(game: "Game", data_type: "DataType", data_source: str = "", file_type: str = "json"):
        if data_source:
    ...
    @staticmethod
    async def save_raw_file(game: "Game", data_type: "DataType", data_source: str, file_type: str, data: bytes):
        """保存原始数据文件"""
